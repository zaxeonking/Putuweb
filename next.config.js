 ...
 * PWA di-handle oleh next-pwa: otomatis generate service worker
 * di public/sw.js saat build, dan di-nonaktifkan saat mode development
 * supaya tidak mengganggu hot reload.
 */
const withPWA = require('next-pwa')({
  ...
  skipWaiting: true, // langsung aktifkan versi SW baru tanpa nunggu tab lain tertutup
  buildExcludes: [/app-build-manifest\.json$/], // hindari error caching manifest build Next.js
